(function(){
	...
	angular.module('RecepcionLibreModule')
		.factory('RecepcionLibreDataApi', ['$http', 'URLS', function ($http, URLS) {
	    	return {
				lista: function (params,success, error) {
	               $http.get(URLS.BASE_API + '/recepcion-sin-acta',{params:params}).success(success).error(error)
				},
				cargarCatalogos: function (success, error) {
					$http.get(URLS.BASE_API + '/recepcion-sin-acta-catalogos').success(success).error(error)
				},
				ver: function (id, success, error) {
					$http.get(URLS.BASE_API + '/recepcion-sin-acta/' + id).success(success).error(error)
				},
				...
				guardarEntrega: function (data, success, error) {
					$http.post(URLS.BASE_API + '/recepcion-sin-acta', data).success(success).error(error)
				},
				editarEntrega: function (id,data, success, error) {
					$http.put(URLS.BASE_API + '/recepcion-sin-acta/'+id, data).success(success).error(error)
				},
	...
	angular.module('RecepcionLibreModule')
		.service('ImprimirEntradaLibre',['$filter','$q',function($filter,$q){
        return {
